package com.bank.bian.creditmanagement.model;
...
/**
 * The BIAN control record for this service domain: "Credit Facility Risk Management Plan".
 *
 ...
 * to its asset type (Credit Facility Risk). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Credit Facility Risk Management Plan";
